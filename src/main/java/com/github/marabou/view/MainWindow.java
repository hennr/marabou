...
public class MainWindow extends BaseGuiClass {
    ...
    public MainWindow(EventBus bus, MainMenu mainMenu, ImageLoader imageLoader, UserProperties userProperties, SidePanel sidePanel, Composite composite,  SashForm sashForm) {
        this.bus = bus;
